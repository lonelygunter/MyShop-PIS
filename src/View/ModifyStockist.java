...
public class ModifyStockist extends JFrame {
    ...
    public ModifyStockist(AdministratorListener adminList) {
        super("Modifica un fornitore");
        ...
        confirm.setActionCommand("confirmModifyStockistButton");
