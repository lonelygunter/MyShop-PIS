...
public class AllUsers extends JFrame {
    ...
    public AllUsers(UserListener uList) {
        super("Elenco degli utenti");

        this.singleItem = new JPanel();
        
        this.item = new JLabel("<html>utente</html>");
        this.checkBox = new JCheckBox(item.getText());
        this.numberItems = new JTextField(10);

        this.buttons = new JPanel();
        this.confirm = new JButton("Conferma");
        confirm.setActionCommand("confirmUserSelectedOrder");
        confirm.addActionListener(uList);
