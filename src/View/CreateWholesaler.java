...
public class CreateWholesaler extends JFrame {
    ...
    public CreateWholesaler(AdministratorListener adminList) {
        super("Crea un gossista");
        ...
        confirm.setActionCommand("confirmCreateWholesalerButton");
