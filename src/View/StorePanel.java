...
public class StorePanel extends JPanel{
    ...
    private String[] filterList = {"", "Id crescente", "Id decrescente"};
    private JComboBox filter;

    private JTable catalog;
    private JScrollPane scrollp;

    public StorePanel(AdministratorListener adminList, NormalCatalogListener ncList, JComboBoxListener jcbList, String sql) {
        this.buttonPanel = new JPanel();

        this.create = new JButton("Gestisci Categorie");
        create.setActionCommand("manageCategoriesButton");
        create.addActionListener(adminList);
        
        this.create = new JButton("Crea");
        create.setActionCommand("createStoreButton");
        create.addActionListener(adminList);

        this.modify = new JButton("Modifica");
        modify.setActionCommand("modifyStoreButton");
        modify.addActionListener(adminList);

        this.delete = new JButton("Cancella");
        delete.setActionCommand("deleteStoreButton");
        delete.addActionListener(ncList);

        this.filter = new JComboBox(filterList);
        filter.addActionListener(jcbList);

        this.catalog = new JTable(new StoresTable(sql));
