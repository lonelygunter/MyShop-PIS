...
public class ModifyStore extends JFrame {
    ...
    public ModifyStore(AdministratorListener adminList) {
        super("Modifica un punto vendita");
        ...
        confirm.setActionCommand("confirmModifyStoreButton");
